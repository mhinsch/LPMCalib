...
@decl_getsetters WorkBlock status outOfTownStudent newEntrant wage initialIncome finalIncome 
@decl_getsetters WorkBlock income jobTenure schedule workingHours workingPeriods pension
